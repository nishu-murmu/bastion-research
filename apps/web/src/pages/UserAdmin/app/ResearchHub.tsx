...
// Latest Updates Popup Component (No changes here)
...
const SpotLights = () => {
    ...
    const mainboardIPOs = [
        { company: 'Urban Company Ltd.', date: '10th Sep 2025', sector: 'Services' },
        { company: 'Dev Accelerator Ltd.', date: '11th Sep 2025', sector: 'Coworking Space' },
        { company: 'Euro Pratik Sales Ltd.', date: '16th Sep 2025', sector: 'Plywood Boards/ Laminates' },
        { company: 'VMS TMT Ltd.', date: '18th Sep 2025', sector: 'Steel' },
    ];

    const smeIPOs = [
        { company: 'Karbonsteel Engineering', date: '10th Sep 2025', sector: 'Iron & Steel Products' },
        { company: 'Airfloa Rail Technology Ltd.', date: '12th Sep 2025', sector: 'Railway Wagons' },
        { company: 'TechD Cybersecurity Ltd.', date: '16th Sep 2025', sector: 'Information Technology' },
    ];
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="flex mb-8">
                    ...
                    <button
                        ...
                        className={`px-8 py-3 font-medium rounded-t-lg ${activeTab === 'ipo' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-700'}`}
                    >
                        IPO Desk
                    </button>
                </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 border-2 border-gray-200">
                            ...
                            {activeTab === 'ipo' && (
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-2 border-gray-200">Company</th>
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-2 border-gray-200">Date</th>
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-2 border-gray-200">Sector</th>
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-2 border-gray-200">Research Material</th>
                                    </tr>
                                </thead>
                                ...
                                {activeTab === 'ipo' && (
                                    <>
                                        <tr className="bg-gray-100">
                                            <td colSpan={4} className="px-6 py-4 text-center font-medium text-gray-700">Mainboard</td>
                                        </tr>
                                        {mainboardIPOs.map((ipo, index) => (
                                            <tr key={`mainboard-${index}`} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.company}</td>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.date}</td>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.sector}</td>
                                                <td className="px-6 py-4 border-2 border-gray-200">
                                                    <Link to="/" className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded text-sm block text-center">IPO Note</Link>
                                                </td>
                                            </tr>
                                        ))}

                                        <tr className="bg-gray-100">
                                            <td colSpan={4} className="px-6 py-4 text-center font-medium text-gray-700">SME</td>
                                        </tr>
                                        {smeIPOs.map((ipo, index) => (
                                            <tr key={`sme-${index}`} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.company}</td>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.date}</td>
                                                <td className="px-6 py-4 text-sm text-gray-900 border-2 border-gray-200">{ipo.sector}</td>
                                                <td className="px-6 py-4 border-2 border-gray-200">
