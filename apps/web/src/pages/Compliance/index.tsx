          ...
          {expandedSections.investor && (
            <div className="ml-6 mt-4 text-gray-700 leading-relaxed">
              <ol className="space-y-6">
                <li>
                  <strong>A. Vision and Mission Statements for investors</strong>
                  <div className="mt-2">
                ...
                <li>
                  <strong>B. Details of business transacted by the Research Analyst with respect to the investors.</strong>
              ...
              <div className="mt-4">
  <strong className="text-base">C. Details of services provided to investors (No Indicative Timelines)</strong>
  <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    <li>To ensure confidentiality of information shared by clients unless such information is required to be provided in furtherance of discharging legal obligations or a client has provided specific consent to share such information</li>
              ...
              <div className="mt-4">
                <strong className="text-base">D. Details of grievance redressal mechanism and how to access it</strong>
                <div className="ml-6 space-y-2">
                  <div className="p-2 bg-white">
    
                    <ol className="list-decimal mt-2 space-y-6">
                      <li>
                        <p className="text-md mb-2">Investor can lodge complaint/grievance against Research Analyst in the following ways:</p>

                        <div className="ml-4">
                          <h2 className="font-medium text-gray-700 mb-1 underline">Mode of filing the complaint with research analyst:</h2>
                          ...
                          <h2 className="font-medium text-gray-700 mb-1 underline">Mode of filing the complaint on SCORES or with Research Analyst Administration and Supervisory Body (RAASB):</h2>
                          <ul className="list-[lower-roman] ml-6 space-y-2 text-gray-600">
                            <li>
                              <strong>SCORES 2.0</strong> - a web based centralized grievance redressal system of SEBI for facilitating effective grievance redressal in time-bound manner
                              <br />
                              <a href="https://scores.sebi.gov.in" className="text-blue-600 hover:underline">https://scores.sebi.gov.in</a>
                              <div className="mt-1 ml-4">
                                <p className="font-medium">Two level review for complaint/grievance against Research Analyst:</p>
                            ...
                            <li>
                              <strong>Email</strong> to designated email ID of RAASB
                            </li>
                          </ul>
                        </div>
                      </li>
                      ...
                      <li>
                        <p className="text-gray-600">
                          If the Investor is not satisfied with the resolution provided by the Market Participants, then the Investor has the option to file the complaint/ grievance on <strong>SMARTODR platform</strong> for its resolution through online conciliation or arbitration.
                        </p>
                      </li>
                    </ol>
                  </div>
                  ...
                  <p>
                    <h2>With regard to physical complaints, investors may send their complaints to:</h2>
                    <strong> Office of Investor Assistance and Education,
                      Securities and Exchange Board of India,
                      SEBI Bhavan, Plot No. C4-A, ‘G’ Block, Bandra-Kurla Complex,
                      Bandra (E), Mumbai - 400 051.</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4">
                <strong>F. Expectations from the investors (Responsibilities of investors)</strong>
                <div className="mt-3">
                  ...
                  <ol className="list-[lower-roman] ml-6 mt-2 space-y-1">
                    ...
                    <li>Ensure the Research Analyst has a valid registration certificate.</li>
                    <li>Check for SEBI registration number.
                      Refer to the list of SEBI registered Research Analysts on SEBI’s website at{" "}
                      <a
    ...
    <table className="w-full border-collapse border border-gray-300 bg-white shadow-sm">
      ...
      <tbody>
        <tr>
          ...
          <td className="border border-gray-300 px-4 py-3 text-center " rowSpan={5}>
