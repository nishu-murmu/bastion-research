  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 text-gray-900">
        <h1 className="text-4xl font-bold mb-6">Terms And Conditions For Bastionresearch.In</h1>
        <p className="mb-6">Effective Date: 1st August 2023</p>

        <p className="mb-6">
          The Website Owner, including subsidiaries and affiliates (“Website” or “Website Owner” or “we” or “us” or “our”) provides the information contained
          on the website or any of the pages comprising the website (“website”) to visitors (“visitors”) (cumulatively referred to as “you” or “your” hereinafter)
          subject to the terms and conditions set out in these website terms and conditions, the privacy policy and any other relevant terms and conditions,
          policies and notices which may be applicable to a specific section or module of the website.
        </p>
        ...
        <p className="mb-6">
          ...
          conditions of use, which together with our <a href="/footer-privacy-policy" className="text-red-600 underline">privacy policy</a> govern BASTION RESEARCH’s relationship with you in relation to this website.
        </p>

        <p className="mb-6">
          The term ‘BASTION RESEARCH’ or ‘us’ or ‘we’ refers to the owner of the website . The term ‘you’ refers to the user or viewer of our website.
        </p>

        <p className="font-semibold mb-4">The use of this website is subject to the following terms of use:</p>
        ...
        <p className="mb-6">
          Your use of any information or materials on this website is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility
          to ensure that any products, services or information available through this website meet your specific requirements.
        </p>
        ...
        <p className="mb-6">
          You may not create a link to this website from another website or document without BASTION RESEARCH’s prior written consent.
        </p>
