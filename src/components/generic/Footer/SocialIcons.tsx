      ...
      {Object.entries(social_links).map(([platform, url]) => {
        ...
        if (url && SvgIcon) {
          ...
          const commonProps = {
            ...
            className: "w-8 h-8  rounded flex items-center justify-center hover:bg-opacity-30 cursor-pointer transition-all",
            'aria-label': platform.charAt(0).toUpperCase() + platform.slice(1), // Capitalize first letter for label
          };
